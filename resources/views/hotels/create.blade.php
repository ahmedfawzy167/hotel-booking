...
@section('page-content')
    <div class="card">
        <div class="card-body container">
            <h1 class="text-center bg-primary text-white"><i class="ion-plus-circled"></i> {{ __('admin.Add New Hotel') }}
            </h1>
            <form action="{{ route('hotels.store') }}" method="POST" enctype="multipart/form-data" class="row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="file" name="images[]" multiple value="{{ old('images') }}" id="images"
